...
static char selbordercolor[]        = "#dd00d7";
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-b", "-fn", dmenufont, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbordercolor, "-sf", selfgcolor, NULL };
...
static Key keys[] = {
    ...
    { MODKEY,			            XK_grave,  spawn,	       SHCMD("xset dpms force off") },
    { MODKEY,			            XK_x,      spawn,	       SHCMD("bash /home/sols/.config/i3/lock.sh") },
    // { MODKEY|ShiftMask,             XK_M,      togglescratch,  {.v = ManScratch } },
